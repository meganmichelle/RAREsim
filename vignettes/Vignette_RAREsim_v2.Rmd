---
title: "RAREsim Vignette V2"
author: "Megan Null"
output:
  rmarkdown::word_document
vignette: >
  %\VignetteEngine{knitr::knitr}
  %\VignetteIndexEntry{RAREsim Vignette V2}
...
There is an example on the [RAREsim github page](https://github.com/meganmichelle/RAREsim/blob/master/HAPGEN2_simulation_example) that shows how to implement the pruning.

This requires the haplotype and legend files and the output from the *Pruning_info* function.
