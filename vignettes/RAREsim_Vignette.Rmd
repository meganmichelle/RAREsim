...
It is currently not recommended to simulate below 2000 individuals. If a smaller sample size is simulated, we recommend simulating 2000 individuals and randomly downsampling to the desired sample size.
...
Ensure the the MAC bin boundaries are defined based on the sample size that will be simulated. See The Allele Frequency Spectrum Function section for recommended MAC bins.
